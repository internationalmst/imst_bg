...
<div class="clearfix"></div>
  ...
  <div class="box-body">
    ...
    FileInput::widget([
        ...
        'pluginOptions' => [
            'uploadUrl' => Url::to('/Xhiddenimstadminurlx/slider/upload-photo'),
            'showPreview' => true,
            'showCaption' => true,
            'showRemove' => false,
            'showUpload' => true,
    ...
    ?>
      ...
      <div class="box box-primary" ng-cloak ng-show="slider.length">
        ...
        <div class="box-body">
          <ul class="products-list product-list-in-box" id="orderedlist">
            <li class="item" ng-repeat="photo in slider" id="photo-{{photo.id}}">
              <div class="product-img">
                <img ng-src="/images/slider/{{photo.photo}}@100x100.jpg">
              </div>
