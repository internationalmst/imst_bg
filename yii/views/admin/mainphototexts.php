...
$this->title = 'Home Page: ' . $model->title_en;
?>
<div class="service-update-box">
  <div class="box-body">
    <div class="service-form">
        ...
        <div class="col-md-12">
          <label><strong>Subtitle En</strong></label>
          <?= $form->field($model, 'subtitle_en')->label(false)->textarea(['class' => 'rich', 'id' => 'gr_text', 'rows' => 10]) ?><br>            
          <?=$form->errorSummary($model, ['header' => '']); ?>
        </div>
        <div class="col-md-12">
          <label><strong>Subtitle Russ</strong></label>
          <?= $form->field($model, 'subtitle_rus')->label(false)->textarea(['class' => 'rich', 'id' => 'rus_text', 'rows' => 10]) ?><br>            
          <?=$form->errorSummary($model, ['header' => '']); ?>
